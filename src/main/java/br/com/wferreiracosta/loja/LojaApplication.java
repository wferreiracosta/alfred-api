package br.com.wferreiracosta.loja;
...
public class LojaApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cli1.getTelefones().addAll(Arrays.asList("1235678", "87654321"));

		Endereco e1 = new Endereco(null, "Rua FLores", "300", "Apto 303", "Jardim", "3822034", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "3822034", cli1, c2);
